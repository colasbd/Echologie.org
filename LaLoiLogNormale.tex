...
A\hphantom{Deca}Connaitre une variable aléatoire, c'est avant tout
...
aléatoire positive et pour tout $a>0$, on a $P\left(A\geq a\right)\leq\frac{1}{a}\cdot E\left(A\right)$.
