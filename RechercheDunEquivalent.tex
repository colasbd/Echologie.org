...
\makeatother
\begin{document}
\title{\large\bf Recherche d'un équivalent}
...
\end{tikzpicture}\textbf{\small{}\phantom{\textbf{\small{}Decale.}}On cherche à déterminer
un équivalent simple de la fonction $f$ au voisinage de $1$ grâce
à un changement de variable. Après \phantom{\textbf{\small{}Decal.}}quelques
lignes plus ou moins laborieuses de calculs pas spécialement intelligents,
on obtiendra l'équivalent $g$ qui, à une translation \phantom{\textbf{\small{}Dec}}et
à une multiplication par une constante près, n'est autre que la fonction
$x\mapsto\frac{1}{x^{2}}$. Le graphique ci-dessous permet de voir
la qualité de l'approximation !\vspace{-15mm}
}{\small \par}
