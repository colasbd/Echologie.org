...
\begin{document}
\begin{onehalfspace}
\title{\Large\bf Sommes de séries arithmétiques}

\textbf{\Large{}$\bullet$ Soient $r\in\mathbb{R}$ et $u$ une suite
arithmétique de raison $r$ définie sur $\mathbb{N}$, i.e. vérifiant
$\forall n\in\mathbb{N},\ u_{n+1}=u_{n}+r$}{\Large \par}

\textbf{\Large{}$\bullet$ Soit $U$ la série associée, i.e. la suite
...
est bijective pour tout $n\in\mathbb{N}$, on a l'égalité suivante
...
\textbf{\Large{}$\bullet$ On en déduit, pour tout $n\in\mathbb{N}$,
la suite d'égalités :
\[
...
\textbf{\Large{}$\bullet$ En définitive, on obtient ${\displaystyle \forall n\in\mathbb{N},\ U_{n}=(n+1)\cdot\frac{u_{0}+u_{n}}{2}}$}{\Large \par}
