...
\begin{document}
\begin{onehalfspace}
\title{\Large\bf Sommes de séries géométriques}
\end{onehalfspace}

\textbf{\Large{}$\bullet$ Soient $q\in\mathbb{R}$ et $v$ une suite
géométrique de raison $q$ définie sur $\mathbb{N}$, i.e. vérifiant
$\forall n\in\mathbb{N},\ v_{n+1}=q\cdot v_{n}$}{\Large \par}

\textbf{\Large{}$\bullet$ Soit $V$ la série associée, i.e. la suite
...
\textbf{\Large{}$\bullet$ Par distributivité du produit sur les sommes,
on a, pour tout $n\in\mathbb{N}$, la suite d'égalités suivante :
\[
...
\textbf{\Large{}$\bullet$ En définitive, nous avons ${\displaystyle \forall n\in\mathbb{N},\ V_{n}=\frac{v_{0}-v_{n+1}}{1-q}}$}{\Large \par}
